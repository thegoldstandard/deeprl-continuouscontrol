...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed=0):
        ...
        self.hard_copy_weights(self.actor_target, self.actor_local) # Added to vanilla implementation
        self.hard_copy_weights(self.critic_target, self.critic_local) # Added to vanilla implementation
    ...
    def learn(self, experiences, gamma):
        ...
        #torch.nn.utils.clip_grad_norm_(self.critic_local.parameters(), 1) # CONSIDER THIS
